;(function (monika){
    ...
    resizeWindow() {
      ...
      if ((this.screenWidth === screenWidth) && this.isTouchScreen) {
        ...
        if (opened) {
          ...
          // resizable windows, and that the height change was the
          // opposite of what would be expected by an on-screen
          // keyboard.
  ...
  monika.mobileKeyboard = new MobileKeyboard()
