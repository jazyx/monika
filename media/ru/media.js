(function (monika) {
  ...
  monika.media = {
    ...
    consonants: {
      ...
      audio: {
        б: ["/monika/media/ru/consonants/б/б"],
        в: ["/monika/media/ru/consonants/в/в"],
        г: ["/monika/media/ru/consonants/г/г"],
        д: ["/monika/media/ru/consonants/д/д"],
        ж: ["/monika/media/ru/consonants/ж/ж"],
        з: ["/monika/media/ru/consonants/з/з"],
        к: ["/monika/media/ru/consonants/к/к"],
        л: ["/monika/media/ru/consonants/л/л"],
        м: ["/monika/media/ru/consonants/м/м"],
        н: ["/monika/media/ru/consonants/н/н"],
        п: ["/monika/media/ru/consonants/п/п"],
        р: ["/monika/media/ru/consonants/р/р"],
        с: ["/monika/media/ru/consonants/с/с"],
        т: ["/monika/media/ru/consonants/т/т"],
        ф: ["/monika/media/ru/consonants/ф/ф"],
        х: ["/monika/media/ru/consonants/х/х"],
        ц: ["/monika/media/ru/consonants/ц/ц"],
        ч: ["/monika/media/ru/consonants/ч/ч"],
        ш: ["/monika/media/ru/consonants/ш/ш"],
        щ: ["/monika/media/ru/consonants/щ/щ"],
      },
    },
    numbers: {
      0: {
        ...
        audio: ["/monika/media/ru/numbers/0/audio/0"],
        words: {
          иней: {
            audio: ["/monika/media/ru/numbers/0/words/иней/audio/иней"],
            images: [
      ...
      1: {
        ...
        audio: ["/monika/media/ru/numbers/1/audio/1"],
        words: {
          рай: {
            audio: ["/monika/media/ru/numbers/1/words/рай/audio/рай"],
            images: [
      ...
      2: {
        ...
        audio: ["/monika/media/ru/numbers/2/audio/2"],
        words: {
          ад: {
            audio: ["/monika/media/ru/numbers/2/words/ад/audio/ад"],
            images: [
      ...
      3: {
        ...
        audio: ["/monika/media/ru/numbers/3/audio/3"],
        words: {
          око: {
            audio: ["/monika/media/ru/numbers/3/words/око/audio/око"],
            images: [
      ...
      4: {
        ...
        audio: ["/monika/media/ru/numbers/4/audio/4"],
        words: {
          чай: {
            audio: ["/monika/media/ru/numbers/4/words/чай/audio/чай"],
            images: [
      ...
      5: {
        ...
        audio: ["/monika/media/ru/numbers/5/audio/5"],
        words: {
          бой: {
            audio: ["/monika/media/ru/numbers/5/words/бой/audio/бой"],
            images: [
      ...
      6: {
        ...
        audio: ["/monika/media/ru/numbers/6/audio/6"],
        words: {
          шея: {
            audio: ["/monika/media/ru/numbers/6/words/шея/audio/шея"],
            images: [
      ...
      7: {
        ...
        audio: ["/monika/media/ru/numbers/7/audio/7"],
        words: {
          оса: {
            audio: ["/monika/media/ru/numbers/7/words/оса/audio/оса"],
            images: [
      ...
      8: {
        ...
        audio: ["/monika/media/ru/numbers/8/audio/8"],
        words: {
          ива: {
            audio: ["/monika/media/ru/numbers/8/words/ива/audio/ива"],
            images: [
          ...
          фея: {
            audio: ["/monika/media/ru/numbers/8/words/фея/audio/фея"],
            images: [
      ...
      9: {
        ...
        audio: ["/monika/media/ru/numbers/9/audio/9"],
        words: {
          яма: {
            audio: ["/monika/media/ru/numbers/9/words/яма/audio/яма"],
            images: [
